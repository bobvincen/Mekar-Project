...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800 mt-2">Tambah Permission Baru</h2>
    <p class="text-sm text-gray-500">Definisikan permission baru yang dapat digunakan untuk proteksi fitur</p>
</div>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 max-w-xl">
    <form action="{{ route('permission.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="name" id="name" required value="{{ old('name') }}" placeholder="Contoh: Kelola Obat, Lihat Laporan"
