...
>>>>>>> f3531ae552f48040cc238153d83a5410e4647c26
...
=======
                    ...
                    <div class="space-y-5">
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1.5">Nama Lengkap <span
                                    class="text-red-500">*</span></label>
                            <input type="text" x-model="form.nama" placeholder="Masukkan nama lengkap Anda"
                                class="w-full px-4 py-3 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 transition-all text-slate-800 placeholder-slate-400 bg-slate-50 focus:bg-white"
                                :class="{ 'border-red-400 ring-1 ring-red-300': errors.nama }">
                            <p x-show="errors.nama" class="text-red-500 text-xs mt-1 font-medium">Nama lengkap wajib diisi
                            </p>
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1.5">Nomor WhatsApp <span
                                    class="text-red-500">*</span></label>
                            <input type="tel" x-model="form.whatsapp" placeholder="Contoh: 081234567890"
                                class="w-full px-4 py-3 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 transition-all text-slate-800 placeholder-slate-400 bg-slate-50 focus:bg-white"
                                :class="{ 'border-red-400 ring-1 ring-red-300': errors.whatsapp }">
                            <p x-show="errors.whatsapp" class="text-red-500 text-xs mt-1 font-medium">Nomor WhatsApp wajib
                                diisi</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-slate-100 rounded-3xl shadow-md p-6 sm:p-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        <label
                            class="relative flex cursor-pointer rounded-2xl border bg-white p-4 shadow-sm focus:outline-none transition-all duration-200"
                            :class="form.metode === 'Ambil di Apotek' ? 'border-blue-500 ring-1 ring-blue-500 bg-blue-50/30' :
                                'border-slate-200 hover:border-blue-200'">
                            <input type="radio" x-model="form.metode" name="metode" value="Ambil di Apotek"
                                class="sr-only">
                            <span class="flex flex-1">
                                <span class="flex flex-col">
                                    <span class="block text-sm font-semibold text-slate-900">Ambil di Apotek</span>
                                    <span class="mt-1 flex items-center text-xs text-slate-500 font-light">Tidak ada biaya
                                        ongkir</span>
                                </span>
                            </span>
                            <svg class="h-5 w-5 text-blue-600"
                                :class="form.metode === 'Ambil di Apotek' ? 'opacity-100' : 'opacity-0'" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z"
                                    clip-rule="evenodd" />
                        ...
                        <label
                            class="relative flex cursor-pointer rounded-2xl border bg-white p-4 shadow-sm focus:outline-none transition-all duration-200"
                            :class="form.metode === 'Antar ke Alamat' ? 'border-blue-500 ring-1 ring-blue-500 bg-blue-50/30' :
                                'border-slate-200 hover:border-blue-200'">
                            <input type="radio" x-model="form.metode" name="metode" value="Antar ke Alamat"
                                class="sr-only">
                            <span class="flex flex-1">
                            ...
                            <svg class="h-5 w-5 text-blue-600"
                                :class="form.metode === 'Antar ke Alamat' ? 'opacity-100' : 'opacity-0'" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path fill-rule="evenodd"
                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z"
                                    clip-rule="evenodd" />
                        ...
                        <label
                            ...
                            :class="form.metode === 'Gunakan Lokasi Saya Saat Ini' ?
                                'border-blue-500 ring-1 ring-blue-500 bg-blue-50/30' :
                                'border-slate-200 hover:border-blue-200'">
                            <input type="radio" x-model="form.metode" name="metode" value="Gunakan Lokasi Saya Saat Ini"
                                class="sr-only">
                            <span class="flex flex-1">
                                <span class="flex flex-col">
                                    <span class="block text-sm font-semibold text-slate-900">Lokasi Saat Ini</span>
                    ...
                    <div x-show="form.metode === 'Antar ke Alamat' || form.metode === 'Gunakan Lokasi Saya Saat Ini'"
                        x-collapse class="mb-6 space-y-6">
                        <div>
                            <div x-show="form.metode === 'Antar ke Alamat'" class="mb-3">
                                <label class="block text-sm font-semibold text-slate-700 mb-1.5">Pilih Lokasi Pengiriman
                                    <span class="text-red-500">*</span></label>
                                <p class="text-xs text-slate-500 font-light">Geser pin atau klik pada peta untuk menentukan
                                    lokasi akurat pengiriman.</p>
                            </div>
                            ...
                            <div id="map" x-ignore
                                class="h-64 sm:h-80 w-full rounded-2xl border border-slate-200 shadow-sm relative z-[1]">
                            </div>
                            <p x-show="errors.location" class="text-red-500 text-xs mt-1.5 font-medium">Lokasi pada peta
                                wajib dipilih</p>
                    ...
                    <div x-show="form.metode === 'Antar ke Alamat' || form.metode === 'Gunakan Lokasi Saya Saat Ini'"
                        ...
                        <textarea x-model="form.alamat" rows="3"
                            ...
                            class="w-full px-4 py-3 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 transition-all text-slate-800 placeholder-slate-400 bg-slate-50 focus:bg-white"
                            :class="{ 'border-red-400 ring-1 ring-red-300': errors.alamat }"></textarea>
                        <p x-show="errors.alamat" class="text-red-500 text-xs mt-1 font-medium">Alamat lengkap wajib diisi
                            untuk pengiriman</p>
                    </div>
                            ...
                            <div class="flex items-start justify-between gap-4">
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        <h3 class="text-sm font-semibold text-slate-900 leading-snug line-clamp-2">
                                            {{ $item['name'] }}</h3>
                                        <p class="text-xs text-slate-500 mt-0.5">{{ $formatRp($item['price']) }} &times;
                                            {{ $item['qty'] }}</p>
                                    </div>
                                </div>
                                <div class="text-right shrink-0 pt-1">
            ...
            <div class="w-full lg:w-[30%] lg:sticky lg:top-24 flex flex-col gap-6">
                ...
                <div class="bg-white border border-slate-100 rounded-3xl shadow-md p-6">
                    ...
                    <button @click="submitOrder()"
                        ...
                        <svg class="w-5 h-5 transition-transform duration-200 group-hover:scale-110 flex-shrink-0"
...
>>>>>>> f3531ae552f48040cc238153d83a5410e4647c26
        ...
        <div x-show="showFeedbackModal"
            ...
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 overflow-hidden"
                ...
                <div class="bg-blue-600 p-6 text-center text-white relative">
                    <button @click="closeFeedbackModal()" class="absolute top-4 right-4 text-blue-200 hover:text-white"
                        x-show="!isSubmittingFeedback">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M6 18L18 6M6 6l12 12" />
                        </svg>
                ...
                <div class="p-6">
                    ...
                    <p x-show="feedbackErrors.rating" class="text-red-500 text-xs text-center -mt-4 mb-4">Silakan berikan
                        rating bintang.</p>
...
>>>>>>> f3531ae552f48040cc238153d83a5410e4647c26
                ...
                updateLocation(lat, lng) {
                    ...
                    fetch(
                            `https://router.project-osrm.org/route/v1/driving/${this.apotekLng},${this.apotekLat};${lng},${lat}?overview=full&geometries=geojson`
                        )
                        .then(res => res.json())
                        .then(data => {
