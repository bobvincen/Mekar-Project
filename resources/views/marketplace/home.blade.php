...
<style>
    ...
    .btn-glow:hover { box-shadow: 0 0 25px rgba(37, 99, 235, 0.6); }
    .marquee-container { display: flex; overflow: hidden; position: relative; width: 100%; }
    .marquee-content { display: flex; animation: marquee 30s linear infinite; gap: 1.25rem; }
    ...
    #modal-qty-input { -moz-appearance: textfield; }
</style>
@endpush
...
<div id="qty-modal" class="hidden fixed inset-0 z-[200] flex items-center justify-center px-4">
    ...
    <div id="qty-modal-box" class="relative bg-white rounded-3xl shadow-2xl w-full max-w-sm p-6 z-10">
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center gap-3">
                <button id="modal-qty-minus"
                    class="w-11 h-11 rounded-xl border-2 border-slate-200 flex items-center justify-center text-slate-600 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50 transition-all font-bold text-xl">
                    −
                </button>
                <input
                    id="modal-qty-input"
        ...
        <button id="modal-submit-btn"
            class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm py-3.5 rounded-2xl shadow-md shadow-blue-600/20 hover:shadow-lg hover:shadow-blue-600/30 transition-all duration-300 flex items-center justify-center gap-2">
            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
        ...
        <div class="relative z-10 w-full max-w-5xl mt-16 pt-8 border-t border-white/10" data-aos="fade-up" data-aos-duration="700" data-aos-delay="500">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 flex items-center gap-3 hover:bg-white/15 transition-colors">
                    <div class="bg-white/20 rounded-xl p-2.5 shrink-0 text-white"><svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg></div>
                    <div><h4 class="text-white text-[13px] sm:text-sm font-bold">Produk Original</h4><p class="text-blue-100 text-[10px] sm:text-xs mt-0.5 font-medium">100% Asli & Terjamin</p></div>
                </div>
                <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 flex items-center gap-3 hover:bg-white/15 transition-colors">
                    <div class="bg-white/20 rounded-xl p-2.5 shrink-0 text-white"><svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" /></svg></div>
                    <div><h4 class="text-white text-[13px] sm:text-sm font-bold">Pengiriman Cepat</h4><p class="text-blue-100 text-[10px] sm:text-xs mt-0.5 font-medium">Langsung ke Rumah</p></div>
                </div>
                <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 flex items-center gap-3 hover:bg-white/15 transition-colors">
                    <div class="bg-white/20 rounded-xl p-2.5 shrink-0 text-white"><svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg></div>
                    <div><h4 class="text-white text-[13px] sm:text-sm font-bold">Konsultasi Ahli</h4><p class="text-blue-100 text-[10px] sm:text-xs mt-0.5 font-medium">Apoteker Profesional</p></div>
                </div>
                <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 flex items-center gap-3 hover:bg-white/15 transition-colors">
                    <div class="bg-white/20 rounded-xl p-2.5 shrink-0 text-white"><svg class="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg></div>
                    <div><h4 class="text-white text-[13px] sm:text-sm font-bold">Pembayaran Aman</h4><p class="text-blue-100 text-[10px] sm:text-xs mt-0.5 font-medium">Transaksi Terenkripsi</p></div>
                </div>
            </div>
        </div>
    </div>
...
<section id="kategori" class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-10 py-8 relative z-10">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-10 gap-3">
        @php
            $svgs = [
                'vitamin'   => 'M10.5 20.5 19 12a4.95 4.95 0 1 0-7-7L3.5 12a4.95 4.95 0 1 0 7 7Z M12 6.5l5.5 5.5',
                'suplemen'  => 'M10.5 20.5 19 12a4.95 4.95 0 1 0-7-7L3.5 12a4.95 4.95 0 1 0 7 7Z M12 6.5l5.5 5.5',
                'perawatan' => 'M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z',
                'kulit'     => 'M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z',
                'p3k'       => 'M12 10v4m-2-2h4M4 8a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V8z',
                'bayi'      => 'M10 2v7.31M14 2v7.31M8.5 2h7M7 9.31a4 4 0 0 0-1 2.62V18a4 4 0 0 0 4 4h4a4 4 0 0 0 4-4v-6.07a4 4 0 0 0-1-2.62L15 9.31',
                'anak'      => 'M12 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z M5 14v7 M19 14v7 M12 21v-4 M10 14l-2.5-4L12 8l4.5 2-2.5 4 M12 11v6',
                'alat'      => 'M16 11V7a4 4 0 0 0-8 0v4 M8 11c0 2.21 1.79 4 4 4h0c2.21 0 4-1.79 4-4v-4 M12 15v3c0 1.1-.9 2-2 2H8c-1.1 0-2-.9-2-2v-3 M20 10.5A2.5 2.5 0 0 0 17.5 8h-1A2.5 2.5 0 0 0 14 10.5v1A2.5 2.5 0 0 0 16.5 14h1A2.5 2.5 0 0 0 20 11.5v-1Z',
                'gigi'      => 'M16.5 4A4.5 4.5 0 0 0 12 8.5 4.5 4.5 0 0 0 7.5 4c-2.5 0-4 1.5-4 4 0 5 3 6 4.5 12 .5 0 1-1 2-4 .5-1.5 1-3 2-3s1.5 1.5 2 3c1 3 1.5 4 2 4 1.5-6 4.5-7 4.5-12 0-2.5-1.5-4-4-4Z',
                'demam'     => 'M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z M12 12v-5M12 15h.01',
                'batuk'     => 'M8 12c-2.5 0-4 1.5-4 4 0 5 3 6 4.5 12 .5 0 1-1 2-4 .5-1.5 1-3 2-3 M16 12c2.5 0 4 1.5 4 4 0 5-3 6-4.5 12-.5 0-1-1-2-4-.5-1.5-1-3-2-3',
                'flu'       => 'M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242 M12 12v9',
                'kepala'    => 'M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z M12 12v6',
                'lambung'   => 'M7 9a5 5 0 0 1 10 0c0 4-3 5-3 7v1a2 2 0 0 1-4 0v-1c0-2-3-3-3-7Z',
                'diare'     => 'M7 9a5 5 0 0 1 10 0c0 4-3 5-3 7v1a2 2 0 0 1-4 0v-1c0-2-3-3-3-7Z',
                'alergi'    => 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z M9 12l2 2 4-4',
                'kesehatan' => 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z M12 8v8 M8 12h8',
                'herbal'    => 'M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12',
                'obat'      => 'M10 4V2 M14 4V2 M8 6v14a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V6 M6 6h12 M10 13h4',
            ];
        @endphp
        @forelse($kategoris as $index => $k)
            @php
                $lowerName = strtolower($k->nama_kategori);
                $iconSvg = 'M10 4V2 M14 4V2 M8 6v14a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V6 M6 6h12 M10 13h4';
                foreach ($svgs as $key => $path) {
                    if (str_contains($lowerName, $key)) { $iconSvg = $path; break; }
                }
                $delay = $index * 30;
            @endphp
            <a href="/category/{{ $k->id }}" class="group flex flex-col items-center p-4 bg-white/80 backdrop-blur-xl border border-white shadow-modern hover:border-blue-200 hover:shadow-modern-hover hover:-translate-y-1 transition-all duration-300 text-center relative overflow-hidden" data-aos="fade-up" data-aos-delay="{{ $delay }}">
                ...
                <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-3 bg-slate-50 border border-slate-100 text-slate-400 group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600 group-hover:scale-110 transition-all duration-300 relative z-10">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="{{ $iconSvg }}" /></svg>
                </div>
...
<section id="produk" class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-10 py-10 relative z-10">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
        @forelse($latestProducts as $index => $p)
            @php
                $imgFallback = str_contains(strtolower($p->kategori->nama_kategori ?? ''), 'vitamin') ? '/premium_supplement_bottle.png' : '/premium_medicine_box.png';
            ...
            <div class="group bg-white/90 backdrop-blur-xl border border-white rounded-2xl overflow-hidden shadow-modern hover:shadow-modern-hover hover:-translate-y-1.5 hover:border-blue-200 transition-all duration-400 flex flex-col justify-between" data-aos="fade-up" data-aos-delay="{{ $delay }}">
                <div class="relative">
                    <div class="absolute left-3 top-3 z-30">
                        <span class="bg-emerald-50 text-emerald-600 border border-emerald-100/60 text-[9px] font-bold px-2 py-1 rounded-lg shadow-sm">Baru</span>
                    </div>
                    ...
                    <div class="p-4 pb-1">
                        <span class="inline-block text-blue-500 text-[10px] font-bold tracking-wider uppercase mb-1.5">{{ $p->kategori->nama_kategori ?? 'Obat' }}</span>
    ...
    <div class="relative rounded-3xl overflow-hidden bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-800 border border-blue-400/30 flex flex-col items-center justify-center min-h-[500px] md:min-h-[550px] p-6 sm:p-10 lg:p-16 shadow-2xl shadow-blue-900/20 group z-10" data-aos="fade-up">
        ...
        <div class="relative z-10 w-full max-w-3xl flex flex-col items-center text-center text-white mt-4">
            ...
            <div class="flex flex-wrap justify-center gap-4 sm:gap-8 mb-10" data-aos="fade-up" data-aos-duration="700" data-aos-delay="300">
                <div class="flex items-center gap-2 text-sm text-white font-medium"><div class="w-6 h-6 rounded-full bg-cyan-400/20 flex items-center justify-center shrink-0"><svg class="w-3.5 h-3.5 text-cyan-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg></div>Gratis konsultasi awal</div>
                <div class="flex items-center gap-2 text-sm text-white font-medium"><div class="w-6 h-6 rounded-full bg-cyan-400/20 flex items-center justify-center shrink-0"><svg class="w-3.5 h-3.5 text-cyan-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg></div>Respon cepat via WhatsApp</div>
                <div class="flex items-center gap-2 text-sm text-white font-medium"><div class="w-6 h-6 rounded-full bg-cyan-400/20 flex items-center justify-center shrink-0"><svg class="w-3.5 h-3.5 text-cyan-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg></div>Apoteker terpercaya</div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const modalBox    = document.getElementById('qty-modal-box');
