...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800 mt-2">Tambah Pelanggan Baru</h2>
    <p class="text-sm text-gray-500">Buat akun pelanggan baru secara manual</p>
</div>
    ...
    <form action="{{ route('customer.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
                ...
                <input type="text" name="name" id="name" required value="{{ old('name') }}" placeholder="Contoh: Budi Santoso"
            ...
            <div>
                ...
                <input type="email" name="email" id="email" required value="{{ old('email') }}" placeholder="pelanggan@domain.com"
            ...
            <div>
                ...
                <input type="text" name="whatsapp" id="whatsapp" required value="{{ old('whatsapp') }}" placeholder="Contoh: 081234567890"
