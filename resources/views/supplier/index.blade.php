...
@section('content')
    <div class="bg-white rounded-3xl shadow-lg p-6 md:p-8">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8">
            ...
            <div class="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                ...
                <a href="{{ route('supplier.create') }}"
                    class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl flex items-center justify-center gap-2 font-semibold shadow-md hover:shadow-lg transition-all duration-200 whitespace-nowrap">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
        ...
        @if (session('success'))
            <div
                class="mb-6 bg-green-50 border-l-4 border-green-500 text-green-800 p-4 rounded-r-xl flex items-center justify-between shadow-sm">
        ...
        <div class="overflow-x-auto border border-gray-100 rounded-2xl shadow-sm">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr
                        class="bg-gray-50 border-b border-gray-100 text-gray-600 font-semibold uppercase text-xs tracking-wider">
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-12 text-gray-500 font-medium bg-gray-50/30">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    @if (request('search'))
                                        <span>Tidak ada supplier yang cocok dengan kata kunci
                                            "{{ request('search') }}"</span>
                                    @else
