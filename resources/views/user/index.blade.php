                    ...
                    @forelse($users as $usr)
                        <tr class="hover:bg-gray-50/50 transition">
                            <td class="py-4 px-6 font-semibold text-gray-900 whitespace-nowrap">
                                ...
                                @if (auth()->id() === $usr->id)
                                    <span
                                        class="ml-2 px-2 py-0.5 text-[10px] font-medium bg-gray-100 text-gray-600 rounded">Saya</span>
                                @endif
                            </td>
                            ...
                            <td class="py-4 px-6 whitespace-nowrap">
                                ...
                                @endphp
                                <span
                                    class="px-2.5 py-1 text-xs font-semibold {{ $badgeClasses }} rounded-lg uppercase tracking-wider">
                                    {{ $roleName }}
                                </span>
                            </td>
                            <td class="py-4 px-6 text-center whitespace-nowrap">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('user.edit', $usr->id) }}"
                                        class="p-2 text-blue-600 hover:bg-blue-50 rounded-xl transition" title="Edit">
