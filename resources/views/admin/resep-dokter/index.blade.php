            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-100 text-sm text-gray-500">
                        ...
                        <th class="py-4 px-6 font-semibold text-center max-w-xs">Catatan</th>
                ...
                <tbody class="divide-y divide-gray-100 text-sm text-gray-700">
                    @forelse($reseps as $resep)
                        <tr class="hover:bg-gray-50/50 transition">
                            ...
                            <td class="py-4 px-6">
                                <a href="https://wa.me/{{ $resep->whatsapp }}" target="_blank"
                                    class="text-blue-600 hover:underline flex items-center gap-1.5">
                            ...
                            <td class="py-4 px-6 text-center">
                                <a href="{{ asset('storage/' . $resep->foto_resep) }}" target="_blank"
                                    ...
                                    <img src="{{ asset('storage/' . $resep->foto_resep) }}" alt="Resep {{ $resep->nama }}"
                                        class="h-14 w-auto rounded border border-gray-200 object-cover">
                                </a>
                            </td>
